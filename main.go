...
var (
	processLockPath   = "/run/cloud-cert-bot/cloud-cert-bot.lock"
	errProcessLocked  = errors.New("another cloud-cert-bot process is already running")
...
func run() int {
	...
	zap.L().Info("starting cloud-cert-bot",
